...
const STRINGS = {
  en: {
    ...
    errMonthlyLimit: "You're out of AI analysis credits for this month (3 used). Upgrade to Pro for unlimited.",
  ...
  fr: {
    ...
    errMonthlyLimit: "Vous n'avez plus de crédits d'analyse IA ce mois-ci (3 utilisés). Passez à Pro pour un accès illimité.",
