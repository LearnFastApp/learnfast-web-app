            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-[#1a2135] px-4 py-3 pr-11 text-white placeholder-slate-500 outline-none focus:border-violet-500"
                />
                <button
                  type="button"
                  tabIndex={-1}
                  onClick={() => setShowPassword((v) => !v)}
                  aria-label={showPassword ? (isFr ? "Masquer" : "Hide password") : (isFr ? "Afficher" : "Show password")}
