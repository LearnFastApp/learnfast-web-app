...
const STRINGS = {
  en: {
    ...
    dropFormats: "MP4, MOV, WebM, MP3, WAV · max 2 GB",
    uploading: "Uploading…",
    ...
    errLimit: "You're out of AI analysis credits for this month (3 used). Upgrade to Pro for unlimited access.",
  ...
  fr: {
    ...
    dropFormats: "MP4, MOV, WebM, MP3, WAV · max 2 Go",
    ...
    errLimit: "Vous n'avez plus de crédits d'analyse IA ce mois-ci (3 utilisés). Passez à Pro pour un accès illimité.",
